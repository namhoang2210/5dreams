...
export default function Welcome({ auth }) {
    ...
    return (
        <>
            <Head title="Welcome" />
            <div className="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-[#fffbfa] selection:bg-red-500 selection:text-white">
